...
<body>
    ...
    <img src="assets_menu/img/kfc.jpg" style="width: 100%">
        ...
        <div class="container">
            ...
            <div class="row projects">
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Burger</h3><a onclick="takeinput('KFC','Burger',100)" id="Burger" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Fondue</h3><a onclick="takeinput('KFC','Fondue',200)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pizza</h3><a onclick="takeinput('KFC','Pizza',180)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pasta</h3><a onclick="takeinput('KFC','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Waffles</h3><a onclick="takeinput('KFC','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Chaat</h3><a onclick="takeinput('KFC','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Nachos</h3><a onclick="takeinput('KFC','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Thai</h3><a onclick="takeinput('KFC','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pancakes </h3><a onclick="takeinput('KFC','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
            </div>
        </div>
