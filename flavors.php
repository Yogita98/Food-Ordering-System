...
<body>
    ...
    <img src="assets_menu/img/flavors.jpg" style="width: 100%">
        ...
        <div class="container">
            ...
            <div class="row projects">
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Burger</h3><a onclick="takeinput('Flavours of China','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Fondue</h3><a onclick="takeinput('Flavours of China','Fondue',200)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pizza</h3><a onclick="takeinput('Flavours of China','Pizza',180)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pasta</h3><a onclick="takeinput('Flavours of China','Pasta',220)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Waffles</h3><a onclick="takeinput('Flavours of China','Waffles',160)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Chaat</h3><a onclick="takeinput('Flavours of China','Chaat',90)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Nachos</h3><a onclick="takeinput('Flavours of China','Nachos',210)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Thai</h3><a onclick="takeinput('Flavours of China','Thai',230)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pancakes </h3><a onclick="takeinput('Flavours of China','Pancakes',170)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
            </div>
        </div>
