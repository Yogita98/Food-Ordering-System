...
<head>
    ...
    <title>The Chocolate Heaven</title>
        ...
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
            <div class="container"><a><img class="image" src="assets_menu/logos/logo1_1.png" style="height:70px; width:70px;"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    ...
                    </ul><span class="navbar-text actions" data-bs-hover-animate="pulse"> <button class="btn btn-light action-button" onclick="document.location.href='register2.php'"data-bs-hover-animate="pulse">Go to Cart</a></span></div>
            </div>
        </nav>
    </div>
    
    <img src="assets_menu/img/chocolate-heaven.jpg" style="width: 100%">
        ...
        <div class="container">
            ...
            <div class="row projects">
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Burger</h3><a onclick="takeinput('Grandmamas Cafe','Burger',100)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Fondue<a onclick="takeinput('Chocolate Heaven','Fondue',200)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pizza</h3><a onclick="takeinput('Chocolate Heaven','Pizza',180)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pasta</h3><a onclick="takeinput('Chocolate Heaven','Pasta',220)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Waffles</h3><a onclick="takeinput('Chocolate Heaven','Waffles',160)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Chaat</h3><a onclick="takeinput('Chocolate Heaven','Chaat',90)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Nachos</h3><a onclick="takeinput('Chocolate Heaven','Nachos',210)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Thai</h3><a onclick="takeinput('Chocolate Heaven','Thai',230)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 item">
                    ...
                    <h3 class="name">Pancakes </h3><a onclick="takeinput('Chocolate Heaven','Pancakes',170)" method="get"><button class="btn btn-primary" type="button">Add to Cart</button></a>
                    <p class="description"></p>
                </div>
            </div>
        </div>
